...
void GetBestSAMAlignmentsInGroup(std::vector<SAMAlignment> & allSAMAlignments,
    ...
    std::string queryName = allSAMAlignments[bestBegin].qName;
...
int main(int argc, char* argv[]) {
    ...
    std::string log = "Filter sam hits.";
    std::string program = "samFilter";
    ...
    std::vector<std::string> allHeaders = samReader.ReadHeader(alignmentSet);
